    ...
    <div className="flex hover:bg-gray-400 hover:bg-opacity-20 p-2 rounded-sm" onClick={() =>{setCurrentSong(info)}}>
        ...
        <div className="flex w-full">
            <div className="text-white flex justify-center flex-col pl-4 w-5/6">
                ...
                <div className="cursor-pointer hover:underline text-xs text-gray-400">{info.artist.firstName + " " + info.artist.lastName}</div>
            </div>
            <div className="w-1/6 text-gray-400 flex justify-center items-center text-sm">
                <div>3:44</div>
            </div>
        </div>
    </div>
